...
public class ProjectDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextFieldDescription.setAutoscrolls(false);
        ...
        jPanelProjectLayout.setVerticalGroup(
            ...
            .addGroup(jPanelProjectLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldDescription, javax.swing.GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabelToolbarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolbarSaveMouseClicked
        ...
        try{
            if(!jTextFieldName.getText().equals("")){
                ...
                JOptionPane.showMessageDialog(rootPane, "O projeto não foi salvo porque o campo nome não foi preenchido.");
            }
        }catch(Exception e){
